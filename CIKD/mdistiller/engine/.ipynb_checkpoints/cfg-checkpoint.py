...
# KD_ CFG
CFG.KD_ = CN()
CFG.KD_.HINT_LAYER = 2  # (0, 1, 2, 3, 4)
CFG.KD_.INPUT_SIZE = (32, 32)
CFG.KD_.TEMPERATURE = 4
CFG.KD_.LOSS = CN()
CFG.KD_.LOSS.CE_WEIGHT = 0.1
CFG.KD_.LOSS.KD_WEIGHT = 0.9
CFG.KD_.A = 2
CFG.KD_.B = 1
CFG.KD_.C = 1.2
CFG.KD_.T_MAX = 9.0
...
CFG.CTKD = CN()
CFG.CTKD.cosine_decay = 1
CFG.CTKD.decay_max = 0
CFG.CTKD.decay_min = -1
CFG.CTKD.decay_loops = 10
CFG.CTKD.T_MAX = 20
CFG.CTKD.T_MIN = 1
CFG.CTKD.LOSS = CN()
CFG.CTKD.LOSS.CE_WEIGHT = 0.1
CFG.CTKD.LOSS.KD_WEIGHT = 0.9
...
CFG.REVIEWKD.IN_CHANNELS = [116,232,464,1024]#shv2[116,232,464,1024]#[16,32,64,64]
CFG.REVIEWKD.OUT_CHANNELS = [32,64,128,128]#[64, 128, 256, 256]#[16,32,64,64]
...
CFG.IAKD.REVIEWKD_WEIGHT = 1.0
CFG.IAKD.WARMUP_EPOCHS = 20
CFG.IAKD.SHAPES = [1,4,8,16]
CFG.IAKD.OUT_SHAPES = [1, 8, 16, 32]
CFG.IAKD.IN_CHANNELS = [116,232,464,1024]#shv2[116,232,464,1024]#[16,32,64,64]
CFG.IAKD.OUT_CHANNELS = [32,64,128,128]#[64, 128, 256, 256]#[16,32,64,64]
