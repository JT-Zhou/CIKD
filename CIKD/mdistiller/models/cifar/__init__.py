...
tiny_imagenet_model_dict = {
     "resnet110": (
        resnet110,
        tiny_imagenet_model_prefix + "resnet110_TinyImageNet/ckpt_epoch_240.pth",
    ),
    "resnet56": (
        resnet56,
        tiny_imagenet_model_prefix + "resnet56_TinyImageNet/ckpt_epoch_240.pth",
    ),
    "wrn_40_2": (
        wrn_40_2,
        tiny_imagenet_model_prefix + "wrn_40_2_TinyImageNet/ckpt_epoch_240.pth",
    ),
    "vgg13": (vgg13_bn, tiny_imagenet_model_prefix + "vgg13_TinyImageNet/ckpt_epoch_240.pth"),
    "vgg8": (vgg8_bn, None),
    "wrn_16_2": (wrn_16_2, None),
}
