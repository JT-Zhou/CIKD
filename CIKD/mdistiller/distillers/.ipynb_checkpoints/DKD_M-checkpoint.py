...
class DKD_M(Distiller_M):
    """Decoupled Knowledge Distillation(CVPR 2022)"""

    def __init__(self, student, teacher1, teacher2, cfg):
        super(DKD_M, self).__init__(student, teacher1, teacher2)
    ...
    def forward_train(self, image, target, **kwargs):
        ...
        # print(1)
        # losses
        loss_ce = 1*self.ce_loss_weight * F.cross_entropy(logits_student, target)
